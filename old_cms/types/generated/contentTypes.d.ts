...
export interface ApiMainMenuMainMenu extends Schema.SingleType {
  ...
  attributes: {
    MainMenuItems: Attribute.DynamicZone<
      ['navigation.nav-link', 'navigation.menu-button', 'navigation.dropdown']
    >;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiNavigationSectionNavigationSection
  extends Schema.CollectionType {
  collectionName: 'navigation_sections';
  info: {
    singularName: 'navigation-section';
    pluralName: 'navigation-sections';
...
export interface ApiPagePage extends Schema.CollectionType {
  ...
  attributes: {
    LandingPage: Attribute.DynamicZone<['layout.hero', 'layout.about']>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::navigation-section.navigation-section': ApiNavigationSectionNavigationSection;
